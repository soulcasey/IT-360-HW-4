...
def collision_constraint(particle1,
	...
	constant_dist = dist - (particle1.r + particle2.r) * 1.1
	...
	if constant_dist < 0 and dist > 0.0001:
		nx = dx / dist
		ny = dy / dist

		correction_x1 = constant_dist * nx / 2
		correction_y1 = constant_dist * ny / 2
		correction_x2 = -constant_dist * nx / 2
		correction_y2 = -constant_dist * ny / 2
